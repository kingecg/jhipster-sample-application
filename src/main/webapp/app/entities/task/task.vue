      ...
      <table class="table table-striped" aria-describedby="tasks">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.task.title')">Title</span></th>
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.task.description')">Description</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
