      ...
      <table class="table table-striped" aria-describedby="countries">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.country.countryName')">Country Name</span></th>
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.country.region')">Region</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
